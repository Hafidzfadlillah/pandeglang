<div class="relative isolate min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat"
    style="background-image: url('/img/pandeglang-bg.jpg');">
    ...
    <div class="relative text-center text-white px-6 max-w-2xl">
        ...
        <p class="mt-8 text-lg font-medium text-gray-200 sm:text-xl/8">
            Kota dengan sejuta pesona alam, budaya, dan peluang investasi menuju Pandeglang Maju dan Sejahtera.
        </p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
            <a href="/about"
                class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow hover:bg-indigo-400">
                Jelajahi Sekarang
            </a>
            <a href="/paket" class="text-sm font-semibold text-white">Lihat Paket <span aria-hidden="true">→</span></a>
        </div>
    </div>
</div>
...
<div class="bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Wisata</h2>
            <p class="mt-2 text-lg/8 text-gray-300">Temukan destinasi wisata terbaik di Pandeglang yang menawarkan
                keindahan alam, budaya, dan pengalaman tak terlupakan.
            </p>
            </p>
        </div>
        <div
            ...
            <article class="flex max-w-xl flex-col items-start justify-between">
                ...
                <div class="group relative grow mt-5">
                    <img src="img/pandeglang-bg.jpg" alt="Pandeglang background"
                ...
                <div class="relative mt-8 flex items-center gap-x-4 justify-self-end">
                    <a href="/paket" class="text-sm font-semibold text-white">Lihat Paket <span
